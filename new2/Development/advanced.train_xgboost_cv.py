...
print(f'Training HistGradientBoosting with enhanced parameters')
print(f'Class weight ratio: {xgb_weight_ratio:.2f}')
print('Using 5-Fold Stratified CV...\n')

# Setup HistGradientBoosting classifier with enhanced parameters
# Increase max_iter and use better hyperparameters to achieve Gini > 0.3
...
xgb_mean_auc = np.mean(xgb_cv_auc_scores)

print(f'\n✓ HistGradientBoosting CV completed!')
print(f'Mean Gini: {xgb_mean_gini:.4f} | Mean AUC: {xgb_mean_auc:.4f}')